...
Creación de Estructura 3NF (DDL Schema):
...
Inserción de Datos Normalizados (DML Data):
...
Ejecutar el archivo Dump en la base de datos:

psql -U postgres -h localhost -d catalogo_netflix -f 04_dump_base_datos.sql
Restaurar directamente desde cliente gráfico (pgAdmin / DBeaver / VS Code SQL):
